...
4. `hypr/assets/deps.sh`, install the dependencies, when prompted to install audio or zsh dependencies that are not need, just cancel them by pressing Ctrl+C
